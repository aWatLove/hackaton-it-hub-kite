...
export const EmailIcon = ({ className, style }: { className?: string; style?: CSSProperties }) => (
    <svg width="20" height="20" className={className} style={style} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
