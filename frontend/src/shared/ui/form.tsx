...
const FormItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => {
    ...
    return (
        <FormItemContext.Provider value={{ id }}>
            <div style={{ marginTop: 8 }} ref={ref} className={cn('mt-0', className)} {...props} />
...
const FormLabel = React.forwardRef<React.ElementRef<typeof LabelPrimitive.Root>, React.ComponentPropsWithoutRef<typeof LabelPrimitive.Root>>(
    ({ className, ...props }, ref) => {
        ...
        return <Label ref={ref} className={cn(error && 'text-destructive mb-[2px]', className)} htmlFor={formItemId} {...props} />;
    },
);
